    ...
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <div className="relative">
        <select
          ...
          ref={ref}
          className={cn(
            "flex h-10 w-full appearance-none rounded-md border border-border-default bg-surface-default px-3 py-2 pr-10 text-sm text-text-primary transition-colors",
